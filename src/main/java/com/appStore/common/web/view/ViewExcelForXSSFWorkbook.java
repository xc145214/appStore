 ...
 *  导出excel view.
 *
 *  @author xiachuan at 2016/7/7 19:54。
 */

public class ViewExcelForXSSFWorkbook extends PoiExcelView {

    private String filename = "report.xlsx";
    public ViewExcelForXSSFWorkbook() {
        super();
    }

    public ViewExcelForXSSFWorkbook(String filename) {
        super();
    ...
    public void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (workbook instanceof SXSSFWorkbook){
            //SXSSFWorkbook处理方式会产生临时文件 导出后清除
